...
classdef Supervisors < handle
    ...
    methods
        ...
        function computeAndMatchClusters(this, data, matchType)
            if nargin<3
                matchType=this.matchType;
            end
            [dns, numClusters, clusterIds]=Supervisors.Cluster(...
                data, this.veryHighClusterDetail);
            this.matchClusters(data, dns, numClusters, clusterIds, matchType);
        end
        ...
        function [qf, qft]=qfTreeSupervisors(this, visible)
            if nargin<2
                visible=true;
            end
            ...
            [tNames, lbls, clrs]=this.getQfTraining;
            [qf, qft]=run_QfTree(this.inputData, lbls, ...
                {'Supervising subsets'}, ...
        ...
        function [qf, qft]=qfTreeSupervisees(this, embedding, rawData, ...
            ...
            [qf, qft]=run_QfTree(rawData, lbls, ...
                {'Supervised subsets'}, ...
                'trainingNames', tNames, ...
                'log10', true, 'colors', clrs);
            if visible
