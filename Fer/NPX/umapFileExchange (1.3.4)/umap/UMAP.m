...
%   License: BSD 3 clause
    ...
    methods
        ...
        function X_new = transform2(U, X)
            ...
            graph = sparse(rows, cols, vals, n_samples, n_samples+embeddingCount);
            ...
            embedding = init_transform(old_cols, old_weights, U.embedding);
            XY_low = vertcat(embedding, U.embedding);
            ...
            X_new = choose_optimize_layout(embedding, XY_low, head,...
                tail, n_epochs, embeddingCount, epochs_per_sample, U.a, ...
                U.b, U.repulsion_strength, U.initial_alpha,...
                U.negative_sample_rate, U.verbose, U.method, ...U.method, ...
                U.progress_callback, U.epoch_reports, U.random_state, ...
                U.min_dist, move_point);
