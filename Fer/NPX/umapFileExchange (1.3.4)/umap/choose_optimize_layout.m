function [embedding, method] = choose_optimize_layout(head_embedding,...
    ...
    progress_callback, epoch_reports, random_state, min_dist, move_point)
...
doingJoinedTransform=nargin==19;
if nargin < 16
    epoch_reports = 0;
    if nargin<15
        progress_callback=[];
...
elseif strcmpi(method, 'C++')
    try
        ...
        [embedding, cmdOut] = StochasticGradientDescent.Go(inFile, ...
            outFile, false, head_embedding, tail_embedding, ...
