...
classdef QfTree < handle
    ...
    methods(Static)
        ...
        function RunWithGt(gt, gid, fcsParams)
            pu=PopUp('Generating phenogram', 'north', 'Note...', false, ...
                true, 'genieSearch.png');
            pu.setTimeSpentTic(tic);
            [teachData, teachCompData, teachCols, teachColNames, teachIds]=...
            ...
            try                
                ...
                bins=0;
                qfTreeCode=1;
                [done, qf]=NdTreeGater.Qf(fcsParams, gt, gid, gt, [], ...
                    ...
                    mergeStrategy);
                if done
                    [~,fig_]=QfTree.ViewWithGt(qf, gt, gid, false);
                    if ~isempty(fig_)
        ...
        function [rc,fig]=ViewWithGt(qf, gt, gid, usePrior)
            fig=[];
            gtp=gt.tp;
            ...
            if usePrior
                ...
                if exists
                    ...
                    qfTree=QfTree.Load(filePath, gt, gid,ttl, mp);
                    fig=qfTree.fig;
                    rc=-1;
                end
            end
