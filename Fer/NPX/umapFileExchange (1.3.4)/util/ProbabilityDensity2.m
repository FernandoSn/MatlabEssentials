...
classdef ProbabilityDensity2 < handle
    ...
    methods(Static)
        function Draw(ax, data, doContours, doJetColors, reset, stretchPerc)
            if nargin<6
                stretchPerc=0;
                if nargin<5
                    reset=true;
        ...
        function [fncMotion, javaLegend, btns, btnLbls]=DrawLabeled(ax, ...
                data, lbls, lblMap, doCntrs, reset, priorFcn, doubleClicker, ...
