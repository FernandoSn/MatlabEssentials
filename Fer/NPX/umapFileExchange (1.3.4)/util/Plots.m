...
classdef Plots < handle
    ...
    methods(Static)
        ...
        function [HL, fncMotion, btns, sortI]=Legend(plotHs, names, ...
            ...
            if ~javaWnd
                ...
                [outerPnl, ~, btns,sortGui]=...
                    ...
                    plots.Hs, cnts2, h, selectedCallback), ...
        ...
        function ok=JavaLegendClick(idx_, sortI, idxsWithName, plotHs, ...
            ...
            if nargin==7
                ...
                if isequal(Plots.DOING_ALL, char(h.getActionCommand))...
                        || ~h.isSelected
            ...
            perc= nums(idx_)/max(nums);
            if perc<.01
                set(plotH, 'MarkerSize', ms+20)
            elseif perc<.02
                set(plotH, 'MarkerSize', ms+12)
            elseif perc<.05
                set(plotH, 'MarkerSize', ms+7)
            elseif perc<.1
                set(plotH, 'MarkerSize', ms+5);
