function [Betas,GoodIdx] = NPX_SUInhAmp2pdf(Raster,ValveTimes, Resp,InhTimes,PREX,POSTX,Fs,PST,trials,NamePDF)


if isempty(trials)
   
    trials = 1:length(Raster{1,1,1}{1});
...
[label, traindata, ~] = BinRearranger(Raster, PST, PST(2) - PST(1), trials);
