...
for ii = 2:UnitsRef+1
    fwrite(fid,SpikesRef.tsec{ii},'double');
end

for ii = 2:UnitsTar+1
    fwrite(fid,SpikesTar.tsec{ii},'double');
end
...
for ii = 1:Valves
    fwrite(fid,efd.ValveTimes.FVSwitchTimesOn{ii},'double');
end

for ii = 1:Valves
    fwrite(fid,efd.ValveTimes.FVSwitchTimesOff{ii},'double');
end

for ii = 1:Valves
    fwrite(fid,efd.ValveTimes.PREXTimes{ii},'double');
end
