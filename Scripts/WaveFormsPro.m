function [WaveForms, Amps] = WaveFormsPro(FilesKK, SpikeType)
...
if ~isempty(strfind(FilesKK.KWIK,'result'))
    ...
    wfsubsample = 1000; % the number of waveforms to work with for position and average
