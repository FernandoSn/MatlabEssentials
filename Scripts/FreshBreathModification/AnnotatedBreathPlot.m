function AnnotatedBreathPlot(handles)
...
currentFVopen = handles.ValveTimes.FVSwitchTimesOn{handles.V}(handles.T);
currentFVclose = handles.ValveTimes.FVSwitchTimesOff{handles.V}(handles.T);
