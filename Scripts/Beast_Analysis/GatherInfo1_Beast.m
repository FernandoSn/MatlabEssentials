function [ValveTimes,LaserTimes,LVTimes,SpikeTimes,PREX,Fs,t,BreathStats,tWarp,warpFmatrix,tFmatrix] = GatherInfo1_Beast(KWIKfile)
...
[SpikeTimes] = CreateSpikeTimes_Beast(FilesKK,Fs,tWarpLinear);
